...
[![GoDoc](https://godoc.org/github.com/shinanca/GoSNMPServer?status.png)](https://godoc.org/github.com/shinanca/GoSNMPServer)
...
```shell
go install github.com/shinanca/GoSNMPServer/cmd/gosnmpserver
...
import "github.com/shinanca/GoSNMPServer/mibImps"
```
...
Serve your own oids
-----
This library provides some common oid for use. See [mibImps](https://github.com/shinanca/GoSNMPServer/tree/master/mibImps) for code, See [![GoDoc](https://godoc.org/github.com/gosnmp/gosnmpServe/mibImpsr?status.png)](https://godoc.org/github.com/shinanca/GoSNMPServer/mibImps) here.
...
Thanks
-----
This library is based on **[soniah/gosnmp](https://github.com/gosnmp/gosnmp)** for encoder / decoders. (made a [fork](https://github.com/gosnmp/gosnmp) for maintenance)
